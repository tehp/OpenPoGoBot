...
class TransferPokemon(object):
    def __init__(self, event_manager, logger):
        ...
        # self.event_manager.add_listener('pokemon_bag_full', self.filter_pokemon, priority=1000)
        # self.event_manager.add_listener('pokemon_bag_full', self.transfer_pokemon, priority=1000)
        # self.event_manager.add_listener('transfer_pokemon', self.transfer_pokemon, priority=1000)
        # self.event_manager.add_listener('pokemon_caught', self.transfer_pokemon, priority=1000)
